            ...
            <div class="flex flex-wrap items-center justify-between gap-4">
                <div class="flex items-center gap-3">
                    <div class="w-12 h-12 rounded-xl bg-cyan-100 flex items-center justify-center">
                        <Pencil class="w-6 h-6 text-cyan-600" />
                    </div>
                    <div>
            ...
            <form class="grid grid-cols-1 gap-6" @submit.prevent="submit">
                <div class="bg-white rounded-lg shadow border border-gray-100 p-6 space-y-5">
                    <div>
                        ...
                        <p class="text-sm text-gray-500">
                            Altere nome, email ou senha de acesso.
                        </p>
                    </div>
                    ...
                    <PasswordInput v-model="form.password" id="password"
                        label="Nova Senha (deixe em branco para manter)" placeholder="Mínimo 8 caracteres"
                        :error="form.errors.password" :required="false" :disabled="form.processing"
